                                ...
                                <tr>
                                    <th>
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Are you sure you want to delete the shopping list?</h1>
                                        </div>
                                    </th>
                                </tr>
                                <tr>
                                    <td>
                                        <a href="<c:url value="/app/list/delete/${id}"/>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> YES </a>
                                    </td>
                                    <td>
